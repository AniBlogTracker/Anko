...
else if( isset($_POST['page-header-search-input2']) )
{
     $search = $_POST['page-header-search-input2'];
}
?>
<!-- Hero Content -->
...
$jsonData = file_get_contents($one->apiurl . "/search/?p=" . $offset . "&q=" . urlencode($search) );
