...
$jsonData = file_get_contents($one->apiurl . "feeds/anime/anilist/". $anime_id ."?p=" . $offset );
...
if ($data !== null && isset($_GET['aid'])) {?>
  <div class="content content-full text-center pt-7 pb-6">
    <h1 class="h2 text-white mb-2">
      Posts about <?php echo($data["anime_info"]["title"]); ?>
    </h1>
...
<?php }?>
  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center push">
      ...
      <li class="page-item">
        <a class="page-link" href="?p=<?php echo($data["page"]["prev"]) . "&aid=" . $anime_id ; ?>" aria-label="Prev">
      ...
      if ($data["page"]["next"]) {?>
      <li class="page-item">
        <a class="page-link" href="?p=<?php echo($data["page"]["next"]) . "&aid=" . $anime_id; ?>" aria-label="Next">
          <span aria-hidden="true">
